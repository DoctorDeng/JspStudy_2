...
//			}
	...
	private  void initDbcp() {
		...
		/*	FileInputStream fileStream = new FileInputStream(configFile);*/
			//this.getClass().getClassLoader().getResourceAsStream(this.prop_file);
			InputStream fileStream = this.getClass().getClassLoader().getResourceAsStream(this.configFile);
